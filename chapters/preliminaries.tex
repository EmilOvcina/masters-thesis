...
This chapter will \textbf{not} go into detail on microservice architectures or APIs in general. It is
expected that the reader will be familiar with the common terminology used when talking about microservices and APIs.
