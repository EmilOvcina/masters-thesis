...
operations the service is capable of invoking internally. \cref{lst:simple-inputport} shows a basic input port in Jolie, where all the key properties are set.
...
\cref{lst:type-with-interf} is an example of a custom type used in an interface in Jolie:
