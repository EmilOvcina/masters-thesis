...
\begin{figure}[h!]
    ...
    \caption{The product, user, and analytics services displayed in the visualization tool's UI. The user and product services have an output port (red) each which is connected to the input port (yellow) of the analytics service.}
...
\subsection{The Completed System}
With all services and ports in place, the system can be seen as one microservice architecture in the visualization UI, as seen in figure \ref*{figure:full_example_lc}.
...
% TODO embedding some service
% TODO aggregation pattern 
% TODO snippets
