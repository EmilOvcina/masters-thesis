...
If the edge goes over networks, the edges are placed in the root of the ELK graph. To determine what edges should be added to the graph, all output ports will be checked to see if a matching input port exists anywhere.
...
% todo more about how Svelte works.
