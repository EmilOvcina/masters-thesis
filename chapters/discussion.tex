...
% API patterns in Jolie - architectures in Jolie - architecture file
% Jolie needs some way of defining architecture. 
...
% find tools that visualize code automatically
...
% 2 options - stick to Jolie or have a separate architecture language and focus on that.
% Lemma for Jolie. Sometimes I need to look at the behaviour of the architecture
...
% Do not lock in to docker-compose
